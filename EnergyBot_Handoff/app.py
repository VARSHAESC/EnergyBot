...
.user-msg { background: #ffffff; border: 1px solid #e2e8f0; color: #0f172a; padding: 12px; border-radius: 12px; margin-bottom: 10px; text-align: right; font-size: 14px; white-space: pre-wrap; }
...
COLORS = {"Gas": "#f59e0b", "Wasser": "#3b82f6", "Strom": "#eab308", "Hoch": "#ef4444", "Mittel": "#f59e0b", "Niedrig": "#22c55e", "Unbekannt": "#94a3b8"}
...
# --- Utility selection cleanup ---
if selected_utility == "Strom":
    selected_utility = "Alle Sparten"
    st.session_state.last_utility = selected_utility
    st.rerun()
